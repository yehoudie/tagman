...
public class ClickRepeater
{
	...
	/**
	 * This is the initial pause until the button is fired for the first time. This is 500 ms as it
	 * the same value used by key events.
	 */
	private final PauseTransition initialPause = new PauseTransition(Duration.millis(500));

	/**
	 * This is for all the following intervals, after the first one. 80 ms is also used by key
	 * events.
	 */
	...
	/**
	 * Store the change listener, so that it can be removed in the
	 * {@link #uninstall(javafx.scene.control.ButtonBase)} method.
	 */
	...
	/**
	 * Installs the click repeating behavior for a {@link ButtonBase}. The default click interval
	 * is 80ms.
	 *
	 * @param buttonBase The button.
	 */
	...
	/**
	 * I nstalls the click repeating behavior for a {@link ButtonBase} and also allows to set a
	 * click interval.
	 *
	 * @param buttonBase The button.
	...
	/**
	 * U ninstalls the click repeater behavior from a button.
	 *
	 * @param buttonBase The button.
	 */
